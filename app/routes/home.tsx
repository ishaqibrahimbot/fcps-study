        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl p-5 border border-slate-200 dark:border-slate-800">
            <p className="text-3xl font-bold text-warning-500">
              {papers.filter((p) => p.latestSession?.status === "in_progress").length}
            </p>
            <p className="text-sm text-slate-500 dark:text-slate-400">
              In Progress
            </p>
          ...
          <div className="space-y-4">
            {papers.map((paper) => (
              <Link
                key={paper.id}
                to={`/paper/${paper.id}`}
                className="block bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800 hover:border-primary-300 dark:hover:border-primary-700 hover:shadow-lg hover:shadow-primary-500/5 transition-all duration-200 group"
              >
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex-shrink-0 w-10 h-10 bg-slate-100 dark:bg-slate-800 rounded-full flex items-center justify-center group-hover:bg-primary-100 dark:group-hover:bg-primary-900/40 transition-colors">
                    <svg
